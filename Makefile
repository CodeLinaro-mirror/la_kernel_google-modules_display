...
CFLAGS_MODULE += -DCONFIG_DRM_SAMSUNG_DECON=1
CFLAGS_MODULE += -DCONFIG_DRM_SAMSUNG_DPP=1
CFLAGS_MODULE += -DCONFIG_DRM_SAMSUNG_DSI=1
CFLAGS_MODULE += -DCONFIG_DRM_SAMSUNG_WB=1
CFLAGS_MODULE += -DCONFIG_DRM_SAMSUNG_TUI=1
CFLAGS_MODULE += -DDYNAMIC_DEBUG_MODULE=1
